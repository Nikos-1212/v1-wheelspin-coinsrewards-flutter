  ...
  Widget build(BuildContext context) {
    ...
    final style = item.style ??
        styleStrategy.getItemStyle(
            theme, index, wheelData.itemCount, sliceItemData,selectedIndex);
        ...
        Transform.translate(
          ...
          child: Transform.rotate(
            ...
            child: _TransformedCircleSlice(
                ...
                index: i,
                wheelData: wheelData,
                sliceItemData: items[i].getsliceItemData,
                selectedIndex: items[i].getSelectedSlice,
                )
